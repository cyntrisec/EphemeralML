...
semantic tag push such as `cluster-a-v1.6` enables publish mode and signs pushed
...
`cluster-a-v1.6` publishes `public.ecr.aws/f4z4g3i5/...:v1.6`.
...
`cluster-a-v1.6.1`, are treated as template hotfixes: the workflow signs and
publishes only the `cluster-a-worker-template` artifact under `/aws/v1.6.1/`
while the template continues to pull the already-published OCI artifacts from
the parent release tag `v1.6`. Full OCI releases use major/minor tags such as
`cluster-a-v1.6`.
...
- `https://s3.us-east-1.amazonaws.com/cyntrisec-public-templates-us-east-1/aws/v1.6/worker.yaml`
- `https://s3.us-east-1.amazonaws.com/cyntrisec-public-templates-us-east-1/aws/v1.6/worker.yaml.sha256`
- `https://s3.us-east-1.amazonaws.com/cyntrisec-public-templates-us-east-1/aws/v1.6/worker.yaml.sig`
- `https://s3.us-east-1.amazonaws.com/cyntrisec-public-templates-us-east-1/aws/v1.6/worker.yaml.cert`
- `https://s3.us-east-1.amazonaws.com/cyntrisec-public-templates-us-east-1/aws/v1.6/worker.yaml.cosign.bundle`
...
`ReleaseTag` to a coherent release set, for example template `v1.6.1` with
OCI `ReleaseTag=v1.6` for a template-only hotfix. Prefer
