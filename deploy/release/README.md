...
semantic tag push such as `cluster-a-v1.4` enables publish mode and signs pushed
...
`cluster-a-v1.4` publishes `public.ecr.aws/f4z4g3i5/...:v1.4`.
...
`cluster-a-v1.4.1`, are treated as template hotfixes: the workflow signs and
publishes only the `cluster-a-worker-template` artifact under `/aws/v1.4.1/`
while the template continues to pull the already-published OCI artifacts from
the parent release tag `v1.4`. Full OCI releases use major/minor tags such as
`cluster-a-v1.4`.
...
- `https://s3.us-east-1.amazonaws.com/cyntrisec-public-templates-us-east-1/aws/v1.4/worker.yaml`
- `https://s3.us-east-1.amazonaws.com/cyntrisec-public-templates-us-east-1/aws/v1.4/worker.yaml.sha256`
- `https://s3.us-east-1.amazonaws.com/cyntrisec-public-templates-us-east-1/aws/v1.4/worker.yaml.sig`
- `https://s3.us-east-1.amazonaws.com/cyntrisec-public-templates-us-east-1/aws/v1.4/worker.yaml.cert`
- `https://s3.us-east-1.amazonaws.com/cyntrisec-public-templates-us-east-1/aws/v1.4/worker.yaml.cosign.bundle`
...
`ReleaseTag` to a coherent release set, for example template `v1.4.1` with
OCI `ReleaseTag=v1.4` for a template-only hotfix. Prefer
