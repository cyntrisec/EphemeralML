...
AMD SEV-SNP provides VM-level isolation with lower overhead; Misono et~al.~\cite{misono2024} report 2--16\% overhead for TensorFlow BERT inference on SEV-SNP (varying with VM and polling configuration), consistent with our \BenchOverheadRange{} result on Nitro Enclaves across three encoder models (22.7M--110M parameters).
