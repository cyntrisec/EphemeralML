...
% --- Title ---
% --- Paper benchmark macros (3-run averages, 2026-02-05) ---
% Commits: MiniLM-L6 & BERT-base at 8fc6c36, MiniLM-L12 at f0b372a
...
All latency measurements use 100 iterations after 3 warmup runs, repeated \BenchNumRuns{} times per model (MiniLM-L6-v2 and BERT-base at commit \texttt{8fc6c36}; MiniLM-L12-v2 at commit \texttt{f0b372a}; inference logic unchanged between commits).
...
Zhu et~al.~\cite{zhu2024} benchmark H100 confidential computing and report $\sim$5--7\% TPS throughput overhead for Llama-3.1-8B (6.9\%) and Phi-3-14B (4.6\%), with negligible overhead for Llama-3.1-70B, though the threat model differs (GPU memory is trusted, CPU-GPU transfers are encrypted).
