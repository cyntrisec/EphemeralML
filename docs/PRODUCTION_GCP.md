...
The legacy `destroy_evidence` field is useful for reporting cleanup actions, but it is
not cryptographic proof of deletion and is not part of frozen AIR v1.
